...
The versioned `public/videos/hero/mobile-jerusalem-v1.*` media was supplied by the site owner on July 26, 2026 as a motion treatment derived from the approved Jerusalem mobile hero artwork. The deployment files are silent H.264 MP4 and VP9 WebM transcodes with a matching WebP first frame. The original emailed `Video.mov` remains outside the public build.
