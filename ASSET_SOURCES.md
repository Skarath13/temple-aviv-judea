...
The ten files under `public/images/art/` were supplied by the site owner on August 1, 2026 and converted from JPEG to metadata-free WebP for the homepage. Each source is used once across the three value cards, story feature, three first-visit cards, two community moments, and recordings card. The desktop and mobile hero artwork, location imagery, and inner-page banners remain unchanged.
