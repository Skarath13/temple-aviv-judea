...
const imageFields = (): TinaField[] => [
	...
	string("imageAlt", "Image description", {
		description:
			"Describe meaningful visual content for visitors using a screen reader.",
	}),
];
...
const gallerySection: Template = {
	...
	fields: [
		...
		list(
			"images",
			"Images",
			[...imageFields(), string("caption", "Caption", { required: false })],
			12,
			"caption",
		),
	],
...
const homeTemplate = pageTemplate("home", "Home", [
	...
	},
	{
		...
		type: "object",
		required: true,
		fields: [string("eyebrow", "Small heading"), string("heading", "Heading")],
	},
	{
		name: "welcome",
	...
	},
	{
		...
		fields: [
			...
			list(
				"stats",
				"Milestones",
				[string("value", "Year or value"), string("label", "Description")],
				4,
				"value",
			),
		],
	...
	},
	{
		...
		fields: [
			...
			list(
				"moments",
				"Photographs",
				[...imageFields(), string("caption", "Caption")],
				2,
				"caption",
				2,
			),
	...
	},
	{
		...
		fields: [
			...
			list(
				"groups",
				"Leadership groups",
				[string("role", "Role"), stringList("names", "Names", 12)],
				8,
				"role",
			),
		],
...
const beliefsTemplate = pageTemplate("beliefs", "Beliefs", [
	...
	},
	{
		...
		type: "object",
		required: true,
		fields: [...imageFields(), string("caption", "Caption")],
	},
	{
		name: "faithIntro",
	...
	),
	{
		...
		fields: [
			...
			list(
				"practices",
				"Prayer practices",
				[string("title", "Title"), string("text", "Description")],
				8,
				"title",
			),
		],
		...
		fields: [
			...
			list(
				...
				[
					string("heading", "Heading"),
					stringList("paragraphs", "Paragraphs", 6),
					string("scripture", "Optional scripture references", {
						required: false,
					}),
				],
				6,
