...
const readFormPath = (value: unknown, path: readonly string[]) => path.reduce<unknown>(
  ...
  fields: [
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'giveLabel', label: 'Give link label', type: 'string', required: true },
        { name: 'visitLabel', label: 'Visit button label', type: 'string', required: true },
        {
    ...
    },
    {
      ...
      type: 'object',
      required: true,
      description: 'Welcome message and section labels shown at the bottom of every page.',
      fields: [
        { name: 'eyebrow', label: 'Welcome eyebrow', type: 'string', required: true },
        { name: 'heading', label: 'Welcome heading', type: 'string', required: true },
        {
          name: 'body',
        ...
        { name: 'visitLabel', label: 'Visit button label', type: 'string', required: true },
        { name: 'exploreHeading', label: 'Explore heading', type: 'string', required: true },
        { name: 'connectHeading', label: 'Connect heading', type: 'string', required: true },
        { name: 'motto', label: 'Footer motto', type: 'string', required: true },
      ],
    },
    {
      name: 'facebook',
      ...
      fields: [
        {
          ...
          ui: {
            validate: (value, allValues, _meta, field) => {
              ...
              return matches > 1 ? 'Each weekday can appear only once.' : undefined;
            },
          },
        },
        {
